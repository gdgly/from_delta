 /*******************************************************************************
 * File name    :   RegBitDefs.h
 * Project      :   Booster digital control
 * Author(s)    :   Dominik Beinlich
 * Created      :   August, 2015
 * Description :    Headerfile for Register Bit Definitions
 *                  This file contains all controller register bit declarations
 *
 * Compiler info :   Cortex M4 compiler
 * Processor info:   STM32F334
 *
 * Copyright (c) 2014 Delta Electronics Thailand Research and Development Center.
 * All rights reserved.
 ******************************************************************************/
 
#ifndef REGBITDEFS_H_
#define REGBITDEFS_H_
...
//---------------------------------------------------------------------------
//HRTIM Configuration Structure definition - typedefs:
//---------------------------------------------------------------------------
...
/* If expr is false, it calls assert_failed function which reports 
