...
#if MG_CRC8_USED
#if MG_CRC8_LOOKUP_TABLE
const uint8 CRC_mg_au8CrcTable[256] = 
{
...
#if MG_CRC16_USED
#if MG_CRC16_LOOKUP_TABLE
/* CRC lookup table polynomial 0xA001 */
...
{
  u8InCrc ^= u8InData;
  return (CRC_mg_au8CrcTable[u8InCrc]);
} /* CRC_u8GetCrc8 */
 ...
 * Returned value:  -
 *
 * Description:     polynomial value 0xA001
 *
 ******************************************************************************/
#if MG_CRC16_USED
#if MG_CRC16_LOOKUP_TABLE
uint16 CRC_u16GetCrc16(uint16 u16InCrc, uint8 u8InData)
{
  ...
  u16Crc = u16InCrc;
  u16Crc = CRC_mg_au16crc16tab[((u16Crc) ^ (u8InData)) & 0xff] ^ ((u16Crc) >> 8);
  return u16Crc;
}
