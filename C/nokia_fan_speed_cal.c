...
#define MG_S16_FAN_CTRL_STAG4_TEMP_MIN_SPEED_LL        ((sint16)3650)
#define MG_S16_FAN_CTRL_STAG4_TEMP_MAX_SPEED_HL        ((sint16)5600)
#define MG_S16_FAN_CTRL_STAG4_TEMP_MIN_SPEED_HL        ((sint16)3650)
#define MG_S16_FAN_CTRL_STAG4_MAX_TEMP                 ((sint16)-20)
#define MG_S16_FAN_CTRL_STAG4_MIN_TEMP                 ((sint16)(-33))

#define MG_U16_FAN_CTRL_VIN_MAX_SPEED1                 ((sint16)4250)
#define MG_U16_FAN_CTRL_VIN_MIN_SPEED1                 ((sint16)0)
#define MG_U16_FAN_CTRL_MAX_VIN_HL                     ((uint16)(217.0F ))
...
#define MG_U16_FAN_CTRL_VIN_MAX_SPEED2                 ((sint16)4250)
#define MG_U16_FAN_CTRL_VIN_MIN_SPEED2                 ((sint16)0)
#define MG_U16_FAN_CTRL_MAX_VIN_LL                     ((uint16)(107.0F ))
...
int main(void)
{
  ...
  else
  {
	...
	if (LOWLINE == u8VinLine)/* low line */
	{
		...
		u8VinNormal = MG_U16_FAN_CTRL_MAX_VIN_LL;
	}
	else/* high line */
	{
		...
		u8VinNormal = MG_U16_FAN_CTRL_MAX_VIN_HL;
	}
  ...
  { /* 50 < Temp < 53*/
    u32FanSpeedAdj += MG_S16_FAN_CTRL_STAG2_TEMP_MAX_SPEED_LL;
  }
	else if ((15 <= MG_S16_FAN_CTRL_TEMP) && (25 > MG_S16_FAN_CTRL_TEMP))
	{
		/* 43 < Temp < 50,,stag2*/
  ...
  {/* 40 < Temp < 43*/
    u32FanSpeedAdj += MG_S16_FAN_CTRL_STAG3_TEMP_MAX_SPEED_LL;
  }
	else if ((0 <= MG_S16_FAN_CTRL_TEMP) && (15 > MG_S16_FAN_CTRL_TEMP))
	{
  ...
  {/* 25 < Temp < 28*/
    u32FanSpeedAdj += MG_S16_FAN_CTRL_STAG4_TEMP_MAX_SPEED_LL;
  }	
 ...
 printf("%d\n",u32FanSpeedAdj);
  /* Control the fan accoiding to the load */
	uint8 u8MaxLoadOffset;
  if(TRUE == u8VinLine)
  {
    u8MaxLoadOffset = 37;/* 1250 * 0.03*/
  }
  else
  {
    u8MaxLoadOffset = 60;/* 2000 * 0.03*/
  }
  ...
  s32VinDiff = (sint32)(u8VinNormal) - (sint32)(u32Vin);
	...
	else
	{
      ...
      {
				s32LoadDiff -= u8MaxLoadOffset;
        u32FanSpeedAdj += (((sint32)((sint32)((27000 - 0) * 128 / s16FanCtrlLoadMax) * ((sint32)s32LoadDiff))) >> 7u )+ 90;
      }
