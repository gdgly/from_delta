...
#define AC_DROPOUT_VIN_HIGH            ((uint16)((uint16)((uint32)((72.0f) * 128UL + 8U)>>4) + SCALE_MN3))
#define AC_DROPOUT_VIN_LOW             ((uint16)((uint16)((uint32)((20.0f) * 128UL + 8U)>>4) + SCALE_MN3))
#define AC_VIN_UV_HIGH                 PSMI_LINEFORMAT_IN(86,5,32)//((uint16)((uint16)((uint32)((85.0f) * 128UL + 8U)>>4) + SCALE_MN3))
#define AC_VIN_UV_LOW                  PSMI_LINEFORMAT_IN(83,5,32)//((uint16)((uint16)((uint32)((79.0f) * 128UL + 8U)>>4) + SCALE_MN3))
#define AC_VIN_UVW_VOLT                PSMI_LINEFORMAT_IN(88,5,32)//((uint16)((uint16)((uint32)((82.0f) * 128UL + 8U)>>4) + SCALE_MN3))

#define AC_VIN_OV_HIGH                 PSMI_LINEFORMAT_IN(280,5,32)//((uint16)((uint16)((uint32)((285.0f) * 128UL + 32U)>>6) + SCALE_MN1))
#define AC_VIN_OV_LOW                  PSMI_LINEFORMAT_IN(270,5,32)//((uint16)((uint16)((uint32)((272.0f) * 128UL + 32U)>>6) + SCALE_MN1))
#define AC_VIN_OCW_CURR								 PSMI_LINEFORMAT_IN(16,6,64)//16A
