...
{.u32Perip=RCC_AHBPeriph_GPIOA, .GPIOx=GPIOA, .u16Pin=GPIO_Pin_8, .Mode_Type=GPIO_Mode_IN, .GPIO_Speed=GPIO_Speed_50MHz, .GPIO_OType=GPIO_OType_PP ,  .GPIO_PuPd=GPIO_PuPd_UP, .u16PinSource=GPIO_PinSource8, .u8GpioAF=GPIO_AF_0, .u8OutState=FALSE}, /* PSON/L signal to PSU */
{.u32Perip=RCC_AHBPeriph_GPIOA, .GPIOx=GPIOA, .u16Pin=GPIO_Pin_9, .Mode_Type=GPIO_Mode_IN, .GPIO_Speed=GPIO_Speed_50MHz, .GPIO_OType=GPIO_OType_PP ,  .GPIO_PuPd=GPIO_PuPd_UP, .u16PinSource=GPIO_PinSource9, .u8GpioAF=GPIO_AF_0, .u8OutState=FALSE}, /* LED Green */
{.u32Perip=RCC_AHBPeriph_GPIOA, .GPIOx=GPIOA, .u16Pin=GPIO_Pin_10,.Mode_Type=GPIO_Mode_IN, .GPIO_Speed=GPIO_Speed_50MHz, .GPIO_OType=GPIO_OType_PP ,  .GPIO_PuPd=GPIO_PuPd_UP, .u16PinSource=GPIO_PinSource10,.u8GpioAF=GPIO_AF_0, .u8OutState=FALSE}, /* LED Amber */
...
{.u32Perip=RCC_AHBPeriph_GPIOA, .GPIOx=GPIOA, .u16Pin=GPIO_Pin_15,.Mode_Type=GPIO_Mode_IN, .GPIO_Speed=GPIO_Speed_50MHz, .GPIO_OType=GPIO_OType_PP ,  .GPIO_PuPd=GPIO_PuPd_UP, .u16PinSource=GPIO_PinSource15,.u8GpioAF=GPIO_AF_0, .u8OutState=FALSE}, /* EEPROM Write Protect */
...
typedef enum PORT_CFG_E_INDEX_
{
  ...
  PORT_CFG_E_A0_NTC_INLET = 0,
	PORT_CFG_E_A1_NTC_OUTLET,
  PORT_CFG_E_A2_UART_TX2,
  PORT_CFG_E_A3_UART_RX2,
  PORT_CFG_E_A4_VSB_ADJ,
  PORT_CFG_E_A5_VSB_V,
  PORT_CFG_E_A6_VSB_I,
  PORT_CFG_E_A7_RESERVE,
  PORT_CFG_E_A8_PSON_L,
	PORT_CFG_E_A9_LED_GRE,
	PORT_CFG_E_A10_LED_AMB,
  PORT_CFG_E_A11_PW_OK,
  PORT_CFG_E_A12_SMBALERT_L,
  PORT_CFG_E_A15_EEPROM_WP,
  /* Port B */
  PORT_CFG_E_B0_56V_FAULT,
  PORT_CFG_E_B1_RESERVE,
  PORT_CFG_E_B2_VSB_OFF,
  PORT_CFG_E_B3_VIN_LINE,
  ...
  PORT_CFG_E_B15_PWM_DEBUG,
  /* Port C */
	PORT_CFG_E_C13_RESERVE,
  PORT_CFG_E_C14_RESERVE,
  PORT_CFG_E_C15_RESERVE,
