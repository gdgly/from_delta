...
#define RTE_PMB_Read_bit_Outlet_Upd()             (PMBUS_uDataUpdStatus1.Bits.TEMP_OUTLET_UPDTING)
#define RTE_PMB_Write_bit_Outlet_Upd(u8Val)       (PMBUS_uDataUpdStatus1.Bits.TEMP_OUTLET_UPDTING = (u8Val))
...
#define RTE_PMB_Read_bit_Llc_Upd()                (PMBUS_uDataUpdStatus1.Bits.TEMP_LLC_UPDTING)
#define RTE_PMB_Write_bit_Llc_Upd(u8Val)          (PMBUS_uDataUpdStatus1.Bits.TEMP_LLC_UPDTING = (u8Val))

#define RTE_PMB_Read_bit_RecDio_Upd()             (PMBUS_uDataUpdStatus1.Bits.TEMP_RECDIO_UPDTING)
#define RTE_PMB_Write_bit_RecDio_Upd(u8Val)       (PMBUS_uDataUpdStatus1.Bits.TEMP_RECDIO_UPDTING = (u8Val))
...
#define RTE_PMB_Read_u16Vout_VSB_Mul_128()        (PMBUS_tData.u16Vout_VSB_Mul_128.u16Val)
#define RTE_PMB_Write_u16Vout_VSB_Mul_128(u16Data)(PMBUS_tData.u16Vout_VSB_Mul_128.u16Val = (u16Data))
...
#define RTE_PMB_Read_u16Temp5_Linear()            (PMBUS_tData.u16Temperatue_5_Linear.u16Val)
#define RTE_PMB_Write_u16Temp5_Linear(u16Data)    (PMBUS_tData.u16Temperatue_5_Linear.u16Val = (u16Data))
