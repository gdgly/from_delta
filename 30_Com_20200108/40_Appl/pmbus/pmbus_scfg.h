...
SINLINE sint16 PMBUS_SCFG_s16ReadOutletTemp(void)
{
...
SINLINE sint16 PMBUS_SCFG_s16ReadPriLlc(void)
{
  return TEMPCTRL_s16ReadTempValue(TEMPCTRL_CFG_E_INDEX_LLC);
}
SINLINE sint16 PMBUS_SCFG_s16ReadSecRecdio(void)
{
...
SINLINE sint16 PMBUS_SCFG_u16ReadAdcAvgOutlet(void)
{
  return TEMPCTRL_u16ReadAdcAvgValue(TEMPCTRL_CFG_E_INDEX_OUTLET);
}
