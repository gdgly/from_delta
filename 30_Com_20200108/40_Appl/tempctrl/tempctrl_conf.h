...
/* PRI LLC */
#define MG_U16_NTC_PRI_LLC_OTP_SETPOINT         ((sint16)125)
#define MG_U16_NTC_PRI_LLC_OTP_RESETPOINT       ((sint16)105)
#define MG_U16_NTC_PRI_LLC_OTW_SETPOINT         ((sint16)120)
#define MG_U16_NTC_PRI_LLC_OTW_RESETPOINT       ((sint16)105)

/* SEC1 RECDIO */
#define MG_U16_NTC_SEC_RECDIO_OTP_SETPOINT       ((sint16)125)
#define MG_U16_NTC_SEC_RECDIO_OTP_RESETPOINT     ((sint16)105)
#define MG_U16_NTC_SEC_RECDIO_OTW_SETPOINT       ((sint16)120)
#define MG_U16_NTC_SEC_RECDIO_OTW_RESETPOINT     ((sint16)105)
