...
void HWIO_vSetGpioPort(void)
{
	...
	/* Set sync internal */
	/* delet PSKILL conditon */
	if(HWIO_Rte_Read_B_R_V1_ON() != HWIO_Rte_Read_B_R_SYNC_INTERNAL_ON())
	{
		HWIO_SCFG_vSetPortSyncInt(HWIO_Rte_Read_B_R_V1_ON());
		HWIO_RTE_Write_B_P_SYNC_INTERNAL_ON(HWIO_Rte_Read_B_R_V1_ON());
	}	
