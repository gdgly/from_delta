...
{
	return PORT_u8ReadGpioPin(PORT_CFG_E_A8_PSON_L);
}

SINLINE uint8 HWIO_SCFG_u8RdPortVmFault(void)
{
	return PORT_u8ReadGpioPin(PORT_CFG_E_B0_56V_FAULT);
}
...
/* 3V3_adjust can cover the Vsb OVP point
...
SINLINE void HWIO_SCFG_vSetEepromWp(uint8 u8Status)
{
  PORT_vSetGpioPin(PORT_CFG_E_A15_EEPROM_WP,(u8Status==FALSE?TRUE:FALSE));
}
#ifdef __cplusplus
  }
#endif
