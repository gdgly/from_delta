...
{.u32Perip=RCC_AHBPeriph_GPIOB, .GPIOx=GPIOB, .u16Pin=GPIO_Pin_3, .Mode_Type=GPIO_Mode_OUT, .GPIO_Speed=GPIO_Speed_50MHz, .GPIO_OType=GPIO_OType_PP ,  .GPIO_PuPd=GPIO_PuPd_UP,     .u16PinSource=GPIO_PinSource3, .u8GpioAF=GPIO_AF_0, .u8OutState=FALSE}, /* Vin line */
