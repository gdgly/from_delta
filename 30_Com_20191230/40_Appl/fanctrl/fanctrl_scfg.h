...
{
	return PORT_u8ReadGpioPin(PORT_CFG_E_A9_FAN1_SPEED);
}

SINLINE uint8 FANCTRL_SCFG_u8RdFan2Status(void)
{
	return PORT_u8ReadGpioPin(PORT_CFG_E_A8_FAN2_SPEED);
}
...
{
	PWM_vPwmDutyUpdate(PWM_CFG_E_INDEX_PWM_Fan_Ctrl,1000u - u16Duty);
}
...
SINLINE sint16 FANCTRL_SCFG_s16ReadSecSr(void)
{
  return TEMPCTRL_s16ReadTempValue(TEMPCTRL_CFG_E_INDEX_SR);
}

SINLINE sint16 FANCTRL_SCFG_s16ReadSecOring(void)
{
