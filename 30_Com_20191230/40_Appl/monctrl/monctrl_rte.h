...
#define Rte_Read_R_u16IinLinear(var)					((**var) = PMBUS_tData.u16Iin_Linear.u16Val)
...
#define RTE_Write_B_P_VIN_OCW           RTE_B_COM_VIN_OCW
...
SINLINE void MONCTRL_RTE_Read_R_vIinLinear(uint16 *var)
{
	Rte_Read_R_u16IinLinear(&var);
}
...
SINLINE void MONCTRL_RTE_Write_B_P_VIN_OCW(uint8 u8Status)
{
	RTE_Write_B_P_VIN_OCW = u8Status;
}
