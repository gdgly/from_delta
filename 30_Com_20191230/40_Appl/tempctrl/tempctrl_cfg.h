...
/* SR NTC */
{
  .s16OTPSetPoint   = MG_U16_NTC_SEC_SR_OTP_SETPOINT,
  .s16OTPResetPoint = MG_U16_NTC_SEC_SR_OTP_RESETPOINT,
  .s16OTWSetPoint   = MG_U16_NTC_SEC_SR_OTW_SETPOINT,
  .s16OTWResetPoint = MG_U16_NTC_SEC_SR_OTW_RESETPOINT,
  .u16OTPDlyTime    = MG_U16_NTC_OTP_DLY,
  .u16OTWDlyTime    = MG_U16_NTC_OTW_DLY,
  .s16DiffByFanFail = MG_CONF_DIFF_BY_FAN_FAIL,
...
/* LLC Oring NTC */
{
  .s16OTPSetPoint   = MG_U16_NTC_SEC_ORING_OTP_SETPOINT,
  .s16OTPResetPoint = MG_U16_NTC_SEC_ORING_OTP_RESETPOINT,
  .s16OTWSetPoint   = MG_U16_NTC_SEC_ORING_OTW_SETPOINT,
  .s16OTWResetPoint = MG_U16_NTC_SEC_ORING_OTW_RESETPOINT,
  .u16OTPDlyTime    = MG_U16_NTC_OTP_DLY,
  .u16OTWDlyTime    = MG_U16_NTC_OTW_DLY,
  .s16DiffByFanFail = MG_CONF_DIFF_BY_FAN_FAIL,
  .u16ReadAdcValue  = TEMPCTRL_Rte_Read_R_u161mVOringNtc
},
...
typedef enum TEMPCTRL_CFG_E_CONF_INDEX_
{
  ...
  TEMPCTRL_CFG_E_INDEX_SR,
  TEMPCTRL_CFG_E_INDEX_ORING,
